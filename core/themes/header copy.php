        ...
        <div class="container-fluid"><button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle me-3" type="button"><i class="fas fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" id='nav_link_panel' href="?panel">Panel</a></li>
                    <li class="nav-item"><a class="nav-link" id='nav_link_clients' href="?clients">Clientes</a></li>
                    <li class="nav-item"><a class="nav-link" id='nav_link_voucher' href="?voucher">Reservas</a></li>
                    <li class="nav-item"><a class="nav-link" id='nav_link_facturas' href="?facturas">Facturas</a></li>
                    <li class="nav-item"><a class="nav-link" id='nav_link_reportes' href="?reports">Reportes</a></li>
                </ul>
            </div>
            <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search" name='main_search'>
                <div class="input-group">
                    ...
                    <button class="btn btn-primary py-0" name="main_search_button" id="main_search_button" type="button" aria-label="Buscar"><i class="fas fa-search"></i></button>
                </div>
            </form>
            <ul class="navbar-nav flex-nowrap ms-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo @ucfirst($_SESSION['USERID']) ?></span>
                            <!--<img class="border rounded-circle img-profile" src="avatars/avatar1.jpeg" />--><i class="fas fa-user-alt"></i>
                        </a>
